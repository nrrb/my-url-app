      ...
      {params.map((param, index) => (
        <React.Fragment key={index}>
          {param.key === "f_TPR" && (
            ...
            >
              Change this to number of seconds you want your job search range to be (keep the leading "r"). For example, 86400 is 24 hours, 28800 is 8 hours, 14400 is 4 hours, 3600 is 1 hour:
            </Typography>
          )}
          <Grid
            container
